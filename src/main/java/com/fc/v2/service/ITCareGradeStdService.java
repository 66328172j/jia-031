...
/**
 * 长者能力分级判定线 Service接口（rule-eval 形状：规则求值，无增删改）
 *
 * @author fuce
 * @date 2026-09-14
 */
public interface ITCareGradeStdService {

    /** 按主键查询规则 */
    TCareGradeStd selectTCareGradeStdById(Long id);
    ...
    List<TCareGradeStd> listAvailable(Date at);

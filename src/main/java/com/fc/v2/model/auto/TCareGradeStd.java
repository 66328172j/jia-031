...
/**
 * 长者能力分级判定线对象 t_care_grade_std
 *
 * @author fuce
 * @date 2026-09-12
 */
@TableName("t_care_grade_std")
@ApiModel(value = "TCareGradeStd", description = "长者能力分级判定线")
public class TCareGradeStd implements Serializable {
    ...
    @ApiModelProperty(value = "判定线编号")
    private String ruleCode;

    /** 判定线名称 */
    @TableField("rule_name")
    @ApiModelProperty(value = "判定线名称")
    private String ruleName;

    /** 一档评分上限 */
    @TableField("th1_max")
    @ApiModelProperty(value = "一档评分上限")
    private BigDecimal th1Max;

    /** 二档评分上限 */
    @TableField("th2_max")
    @ApiModelProperty(value = "二档评分上限")
    private BigDecimal th2Max;

    /** 三档评分上限 */
    @TableField("th3_max")
    @ApiModelProperty(value = "三档评分上限")
    private BigDecimal th3Max;

    /** 开始施用时刻 */
    @TableField("eff_start")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @ApiModelProperty(value = "开始施用时刻")
    private Date effStart;

    /** 让位截止时刻(不含) */
    @TableField("eff_end")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @ApiModelProperty(value = "让位截止时刻(不含)")
    private Date effEnd;
    ...
    /** 判定线状况 0现行 1已让位 */
    @TableField("status")
    @ApiModelProperty(value = "判定线状况 0现行 1已让位")

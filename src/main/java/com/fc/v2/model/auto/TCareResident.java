...
/**
 * 长者入住档案对象 t_care_resident
 *
 * @author fuce
 * @date 2026-09-12
 */
@TableName("t_care_resident")
@ApiModel(value = "TCareResident", description = "长者入住档案")
public class TCareResident implements Serializable {
    ...
    @ApiModelProperty(value = "照护类别")
    private String siteType;

    /** 所属护理分区 */
    @TableField("road_name")
    @ApiModelProperty(value = "所属护理分区")
    private String roadName;

    /** 本长者核定一档项数上限 */
    @TableField("th1_max")
    @ApiModelProperty(value = "本长者核定一档项数上限")
    private BigDecimal th1Max;

    /** 本长者核定二档项数上限 */
    @TableField("th2_max")
    @ApiModelProperty(value = "本长者核定二档项数上限")
    private BigDecimal th2Max;

    /** 本长者核定三档项数上限 */
    @TableField("th3_max")
    @ApiModelProperty(value = "本长者核定三档项数上限")
    private BigDecimal th3Max;

    /** 档案状况 0在住 1已退住 */
    @TableField("status")
    @ApiModelProperty(value = "档案状况 0在住 1已退住")
